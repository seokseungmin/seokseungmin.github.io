...
GenericXmlApplicationContext ctx = new GenericXmlApplicationContext("classpath:appCtxImport.xml");<br>
...
이와 반대대는 개념인 프로토타입은 밑에 설명을 참조하세요.
...
<br>스프링에서 모든 객체는 스프링 컨테이너에 의해 생성됩니다. <br>
