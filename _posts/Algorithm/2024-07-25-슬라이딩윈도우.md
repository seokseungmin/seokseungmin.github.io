...
변수 초기화
answer = 0
nH = {0: 1} (부분합이 0인 경우를 처리하기 위해 초기화)
sum = 0
부분합 계산 및 해시맵 업데이트
첫 번째 원소 (2)

sum += 2 → sum = 2
nH.containsKey(sum - m) → nH.containsKey(2 - 5) → nH.containsKey(-3) → false
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(2, 1) → nH = {0: 1, 2: 1}
두 번째 원소 (2)

sum += 2 → sum = 4
nH.containsKey(sum - m) → nH.containsKey(4 - 5) → nH.containsKey(-1) → false
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(4, 1) → nH = {0: 1, 2: 1, 4: 1}
세 번째 원소 (3)

sum += 3 → sum = 7
nH.containsKey(sum - m) → nH.containsKey(7 - 5) → nH.containsKey(2) → true
answer += nH.get(sum - m) → answer += nH.get(2) → answer += 1 → answer = 1
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(7, 1) → nH = {0: 1, 2: 1, 4: 1, 7: 1}
네 번째 원소 (-1)

sum += -1 → sum = 6
nH.containsKey(sum - m) → nH.containsKey(6 - 5) → nH.containsKey(1) → false
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(6, 1) → nH = {0: 1, 2: 1, 4: 1, 7: 1, 6: 1}
다섯 번째 원소 (-1)

sum += -1 → sum = 5
nH.containsKey(sum - m) → nH.containsKey(5 - 5) → nH.containsKey(0) → true
answer += nH.get(sum - m) → answer += nH.get(0) → answer += 1 → answer = 2
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(5, 1) → nH = {0: 1, 2: 1, 4: 1, 7: 1, 6: 1, 5: 1}
여섯 번째 원소 (-1)

sum += -1 → sum = 4
nH.containsKey(sum - m) → nH.containsKey(4 - 5) → nH.containsKey(-1) → false
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(4, 2) → nH = {0: 1, 2: 1, 4: 2, 7: 1, 6: 1, 5: 1}
일곱 번째 원소 (3)

sum += 3 → sum = 7
nH.containsKey(sum - m) → nH.containsKey(7 - 5) → nH.containsKey(2) → true
answer += nH.get(sum - m) → answer += nH.get(2) → answer += 1 → answer = 3
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(7, 2) → nH = {0: 1, 2: 1, 4: 2, 7: 2, 6: 1, 5: 1}
여덟 번째 원소 (2)

sum += 2 → sum = 9
nH.containsKey(sum - m) → nH.containsKey(9 - 5) → nH.containsKey(4) → true
answer += nH.get(sum - m) → answer += nH.get(4) → answer += 2 → answer = 5
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(9, 1) → nH = {0: 1, 2: 1, 4: 2, 7: 2, 6: 1, 5: 1, 9: 1}
아홉 번째 원소 (1)

sum += 1 → sum = 10
nH.containsKey(sum - m) → nH.containsKey(10 - 5) → nH.containsKey(5) → true
answer += nH.get(sum - m) → answer += nH.get(5) → answer += 1 → answer = 6
nH.put(sum, nH.getOrDefault(sum, 0) + 1) → nH.put(10, 1) → nH = {0: 1, 2: 1, 4: 2, 7: 2, 6: 1, 5: 1, 9: 1, 10: 1}
최종 결과
answer = 6
